...
public class Console {
	 ...
	 *
	 * @param console the {@link ca.jarcode.consoles.internal.ManagedConsole} to wrap
	 ...
	 * @return a {@link ca.jarcode.consoles.api.CanvasComponentBuilder} with the given dimensions
	 */
