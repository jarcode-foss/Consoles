...
public class CanvasComponentBuilder {
	 ...
	 * internally calling {@link ca.jarcode.consoles.api.CanvasComponent#setEnabled(boolean)}
	 *
	...
	/**
	 * Sets the functions to be used for {@link ca.jarcode.consoles.api.CanvasComponent#setEnabled(boolean)} and
	 * {@link ca.jarcode.consoles.api.CanvasComponent#enabled}. If any of the arguments are null, the default
