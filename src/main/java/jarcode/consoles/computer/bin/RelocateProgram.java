...
import static jarcode.consoles.computer.ProgramUtils.schedule;

@ProvidedManual(
		author = "Jarcode",
		version = "1.3",
		contents = "Opens a dialog that presents the option to relocate the computer. " +
				"Only the owner of this computer can authorize this. Data is preserved " +
				"when moving the computer."
)
public class RelocateProgram extends FSProvidedProgram {
	@Override
	public void run(String str, Computer computer) throws Exception {
		schedule(() -> {
			...
			Position2D pos = computer.dialog("Are you sure you want to relocate (drop) this computer?", delete, deny);
